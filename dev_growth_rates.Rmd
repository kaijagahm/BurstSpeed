...
# Crop logger temps to the developmental period
loggers_cropped <- loggers_tojoin %>%
  filter(date >= min_ovip & date <= max_wild_coll)
...
save(loggers_cropped, file = "data/outputs/loggers_cropped.Rda")
```
