...
# Straight line speed by pond (excluding high outliers)
stats %>% filter(crop == "First half second") %>% ggplot()+
  geom_boxplot(aes(x = factor(pond), y = sline_speed_m_s))+
  ggtitle("Straight line speed by pond")+
  xlab("Pond")+
  ylab("Straight line speed, first half second")

# Straight line speed by treatment
stats %>% filter(crop == "First half second") %>% ggplot()+
  geom_boxplot(aes(x = treatment, y = sline_speed_m_s))+
  ggtitle("Straight line speed by treatment")+
  xlab("Treatment")+
  ylab("Straight line speed, first half second")
```
