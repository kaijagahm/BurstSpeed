...
# Basic linear model: pond and size
wm5lm <- lm(sline_speed_m_s ~ size + pond,
            data = wild_nonas,
            na.action = "na.fail")
summary(wm5lm)

# Examine VIF's
full <- lmer(sline_speed_m_s ~ size + mass + gs + T_initial + (1 | pond/tadpole),
             data = wild_nonas,
             REML = FALSE,
             na.action = "na.fail")
vif(full)
...
# Remove mass
full_1 <- lmer(sline_speed_m_s ~ size + gs + T_initial + (1 | pond/tadpole),
             data = wild_nonas,
             REML = FALSE,
             na.action = "na.fail")
vif(full_1)
